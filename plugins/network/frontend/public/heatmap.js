(function () {
    ...
    Countly._internals.loadCSS(Countly.url + "/stylesheets/ionicons/css/ionicons.min.css", function () {
        Countly._internals.loadCSS(Countly.url + "/network/stylesheets/heatmap.css", function () {
    ...
    function loadClickMap(cb) {
        ...
        Countly._internals.loadJS(Countly.url + "/network/javascripts/simpleheat.js", function () {
